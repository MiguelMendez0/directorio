...
$query = "SELECT u.nombre, AtencionContrato, AtencionNCliente, AtencionProblema, AtencionCSolucion, AtencionRazon, AtencionHora, AtencionFecha, AtencionSolucion, AtencionTransferencia, AtencionTipo FROM atenciones a INNER JOIN usuario u ON a.AtencionUsuario = u.id_usuario WHERE u.id_tipo = 2";
