...
$query = "SELECT AtencionMContrato, AtencionNMCliente, AtencionMRazon, AtencionMSolucion, AtencionMReporte, AtencionMTecnico,  AtencionMHora, AtencionMFecha FROM atencionesm a INNER JOIN usuario u ON a.AtencionMUsuario = u.id_usuario WHERE u.id_usuario = ?";
...
$spreadsheet = IOFactory::load('documentos/ATENCIONESM.xlsx');
