...
$query = "SELECT u.nombre, AtencionMContrato, AtencionNMCliente, AtencionMRazon, AtencionMSolucion, AtencionMReporte, AtencionMTecnico, AtencionMHora, AtencionMFecha FROM atencionesm a INNER JOIN usuario u ON a.AtencionMUsuario = u.id_usuario WHERE u.id_tipo = 5";
...
$spreadsheet = IOFactory::load('documentos/ATENCIONESGM.xlsx');
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    $sheet->setCellValue('B4', 'No se encontraron registros.');
}
